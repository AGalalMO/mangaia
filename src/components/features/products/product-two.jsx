...
import { isInWishlist, isInCompare } from '~/src/utils/shared';
...

                {
                    product.stock && product.stock !== 0 ?
                        <div className="product-action action-icon-top">
                            ...
                            <button className="btn-product btn-compare" title="Compare" onClick={ onCompareClick }>
                                <span>compare</span>
                            </button>
                        </div>
                        :
...
export default connect( mapStateToProps, { ...wishlistAction, ...cartAction, ...compareAction, ...demoAction } )( ProductTwo );
