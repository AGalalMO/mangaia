                            ...
                            <Tabs selectedTabClassName="show" defaultIndex={0}>
                                ...
                                <div className="tab-content">
                                    ...
                                    <TabPanel>
                                        <form action="#">
                                            <div className="form-group">
                                                <label htmlFor="register-name-2">username *</label>
                                                <input type="string" className="form-control" id="register-name-2" name="register-name" required />
                                            </div>
                                            <div className="form-group">
                                                <label htmlFor="register-mobile-2">Mobile phone *</label>
                                                <input type="number" className="form-control" id="register-mobile-2" name="register-mobile" required />
                                            </div>
                                            <div className="form-group">
