            ...
            <div className="page-content">
                {
                    !loading ?
                        post.image.length <= 1 ?
                            <figure className={ `entry-media entry-media-fullwidth ${post.type == 'video' ? 'entry-video' : ''}` } style={ { paddingTop: `500px` } }>
                                {
                                    post.type !== 'video' ?
                                        <>
                            ...
                            :
                            <figure className="entry-media entry-gallery" style={ { paddingTop: `500px` } }>
