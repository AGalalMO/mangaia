...
import ProductThriteen from '~/components/features/products/product-thirteen'
                ...
                <div className="products-container mb-7">
                    <div className="products-container mb-7">
                        ...
                        <div className="more-container text-center mt-0 mb-0">
                            <ALink href="/shop/sidebar/list" className="btn btn-outline-primary-2 btn-more">
            ...
            <aside className="col-lg-3">
                <div className="sidebar sidebar-home">
                    <div className="row">
                        <div className="col-sm-6 col-lg-12">
                            <div className="widget widget-products">
                                ...
                                <div className="products">
                                    {
                                        products ?
                                            attrFilter( products, 'top' ).slice( 0, 4 ).map( ( item, index ) =>
                                                <ProductThriteen product={ item } key={ "Best" + index } />
                                            )
                                            :
                                            new Array( 4 ).fill( 1 ).map( ( item, index ) =>
                                                <div className="skel-pro skel-pro-list" key={ "Best" + index } ></div>
                                            )
                                    }
                                </div>
                            </div>
                        ...
                        <div className="col-sm-6 col-lg-12">
                            <div className="widget widget-subscribe" style={ { backgroundImage: 'url(images/home/bg-newsletter.jpg)' } }>
                            ...
                            <div className="widget widget-banner">
                                <div className="banner banner-overlay lazy-media">
                                    ...
                                    <div className="banner-content">
                                        <h4 className="banner-subtitle"><a href="#">Spring 2019</a></h4>
                                        <h3 className="banner-title"><a href="#">SAVE UP TO <br />50% OFF</a></h3>
                                        <ALink href="/shop/sidebar/list" className="banner-link">Shop Now</ALink>
                                    </div>
                                </div>
                            </div>
                        </div>
